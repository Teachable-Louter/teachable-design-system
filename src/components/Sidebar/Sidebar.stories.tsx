...
export const Default: Story = {
	args: {
		buttonStyle: 'start',
		title: ['입력 방법','삭제 방법'],
		description: [['입력을 하기위해 더블클릭\n 또는 Enter키를 치세요.', '성명 입력 후에는 반드시 Enter키를 치세요.', '정식 과목명에는 과목의\n 실제 명칭을 기제하세요.\n(예. 수학 과목이 여러개인\n 경우 수학1: X 수학: O)','단축 과목명에는 시간표에 들어갈 과목 명칭을 작성하세요'],['중간의 과목은\n 삭제 할 수 없습니다.', '맨 끝 과목만 삭제 가능합니다.']]
	},
};
